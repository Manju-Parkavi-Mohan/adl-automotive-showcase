        ...
        <div className="flex flex-col gap-5 md:flex-row md:items-stretch">
          ...
          <div className="relative min-w-0 flex-1">
            ...
            <button
              ...
              disabled={!canLeft}
              className="absolute start-1 top-[55%] z-10 grid h-8 w-8 -translate-y-1/2 place-items-center rounded-full bg-white shadow-md transition-opacity hover:bg-black hover:text-white disabled:opacity-30 sm:h-10 sm:w-10"
            >
            ...
            <button
              ...
              onClick={() => stepScroll(1)}
              disabled={!canRight}
              className="absolute end-1 top-[55%] z-10 grid h-8 w-8 -translate-y-1/2 place-items-center rounded-full bg-white shadow-md transition-opacity hover:bg-black hover:text-white disabled:opacity-30 sm:h-10 sm:w-10"
            >
